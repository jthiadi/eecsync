...
Future<String> getrectanglerecom(
  ...
  final prompt = '''
    You are an academic advisor assistant. Your job is to recommend courses from the available course list, graduation requirement, student's preference, students, performance, and available time slots.
    ...
    - Prioritize fulfilling graduation requirements based on the urgency of each requirement. (second priority)
    ...
    - The student's preference of courses are the courses related to ${preferences} -> (if its empty then the student have no preference) this is the second priority
    ...
    - The first priority is to choose only the available course code. Strictly do not choose courses that is not in the available courses listed below.
    ...
    Based on this information, suggest up to 7 courses from the courses available given that could be suitable for this student.
